...
<?php include "./page_section/board/introduce.php";?>
    <form action="action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="제목" name="title" minlength="1" maxlength="50">
        </div>
        <div class="form-floating">
            <textarea class="form-control" placeholder="본문" id="floatingTextarea2" style="height: 300px" name="content" minlength="1" maxlength="300"></textarea>
        </div>
        <br>
        <div class="mb-3">
